...
describe('LoginForm Component', () => {
  ...
  it('shows validation errors for empty fields', () => {
    ...
    cy.get('[data-testid="email-input"]').parent().find('p').should('have.text', 'Invalid email address');
  ...
  it('calls onLogin and onStatusUpdate on valid submit', () => {
    ...
    cy.get('@onStatusUpdate').should('have.been.calledWith', 'Login successful', 'success');
  });
});
